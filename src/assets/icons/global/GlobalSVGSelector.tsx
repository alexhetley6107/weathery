...
export const GlobalSVGSelector = ({ id }: Props) => {
	...
	switch (num) {
		case 200:
			return (
				<svg width='48' height='48' x='0px' y='0px' viewBox='0 0 406.02 406.02'>
					<g>
						<polygon
							points='306.79,196.3 275.26,250.23 257.9,279.93 295.21,279.93 189.71,406.02 229.59,299.23 
		190.99,299.23 207.47,250.41 225.73,196.3 	'
							fill='#FFB301'
						/>
						<path
							d='M347.16,126.42c24.32,9.03,41.66,32.45,41.66,59.92c0,35.28-28.61,63.89-63.89,63.89h-49.67
		...
		case 600:
			return (
				<svg
					...
					<path
						fill='#88C9F9'
						d='M33.915 13.907l-4.664-1.25l3.972-2.293s.867-.501.367-1.367c-.501-.867-1.367-.366-1.367-.366l-3.971 2.292l1.249-4.663s.259-.966-.707-1.225c-.966-.259-1.225.707-1.225.707l-1.767 6.595l-16.604 9.589l-6.594-1.768s-.966-.259-1.225.707c-.26.967.707 1.225.707 1.225l4.663 1.249l-3.971 2.293s-.865.501-.365 1.367c.5.865 1.365.365 1.365.365l3.972-2.293l-1.25 4.663s-.259.967.707 1.225c.967.26 1.226-.706 1.226-.706l1.768-6.597l16.604-9.585l6.595 1.768s.966.259 1.225-.707c.255-.967-.71-1.225-.71-1.225z'></path>
				</svg>
			);
		case 700:
			return (
